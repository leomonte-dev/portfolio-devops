    ...
    <div className="min-h-screen bg-gray-100">
      ...
      <div className="max-w-[1600px] mx-auto flex flex-col lg:flex-row">
        ...
        <main className="flex-1 min-w-0 p-4 md:p-6">
          ...
          <div className="grid md:grid-cols-2 2xl:grid-cols-4 gap-4 mb-8">
          ...
          <div className="bg-[#c0c0c0] border-2 border-t-white border-l-white border-b-gray-700 border-r-gray-700 p-1 font-mono text-sm">
            ...
            <div className="bg-black text-green-400 border-2 border-t-gray-700 border-l-gray-700 border-b-white border-r-white p-3 overflow-x-auto">
